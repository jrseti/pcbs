...
/* ----------------------------------------------------------------------- */
/* Axis 1 (AZ) Encoder Config (0x0010 - 0x0017)                           */
/* ----------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------- */
/* Axis 1 (AZ) PID Config (0x0020 - 0x0026)                               */
/* ----------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------- */
/* Axis 1 (AZ) Motion Command (0x0030 - 0x0037)                           */
/* ----------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------- */
/* Axis 1 (AZ) Status (0x0040 - 0x0049)                                   */
/* ----------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------- */
/* Axis 2 (EL) Encoder Config (0x0070 - 0x0077)                           */
/* ----------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------- */
/* Axis 2 (EL) PID Config (0x0080 - 0x0086)                               */
/* ----------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------- */
/* Axis 2 (EL) Motion Command (0x0090 - 0x0097)                           */
/* ----------------------------------------------------------------------- */
...
/* ----------------------------------------------------------------------- */
/* Axis 2 (EL) Status (0x00A0 - 0x00A9)                                   */
/* ----------------------------------------------------------------------- */
