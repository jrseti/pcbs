...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, ENABLE_Pin|DIR_Pin|STATUS_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : ECN_Z_Pin */
  GPIO_InitStruct.Pin = ECN_Z_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(ECN_Z_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : LIMIT_SW1_Pin LIMIT_SW2_Pin ADDR0_Pin ADDR1_Pin
                           ADDR2_Pin */
  GPIO_InitStruct.Pin = LIMIT_SW1_Pin|LIMIT_SW2_Pin|ADDR0_Pin|ADDR1_Pin
                          |ADDR2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

  /*Configure GPIO pins : ENABLE_Pin DIR_Pin STATUS_LED_Pin */
  GPIO_InitStruct.Pin = ENABLE_Pin|DIR_Pin|STATUS_LED_Pin;
